    ...
    public partial class frmCoffee : Form
    {
        ...
        private void btnCoffeeAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (rdbCoffeeSmall.Checked)
                {
                    //
                    size = "Small";
                }

                else if (rdbCoffeeMedium.Checked)
                {
                    //
                    size = "Medium";
                }

                else if (rdbCoffeeLarge.Checked)
                {
                    //
                    size = "Large";
                }
                ...
                string type = cmbCoffeeType.SelectedItem.ToString();
                int quantity = Convert.ToInt32(nudCoffeeQuantity.Value);
