...
{
    public partial class frmPastries : Form
    {
        public frmPastries()
        {
            InitializeComponent();
        ...
        private void btnPastriesAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string type = cmbPastriesType.SelectedItem.ToString();
                int quantity = Convert.ToInt32(nudPastriesQuantity.Value);
        ...
        private void frmPastries_Load(object sender, EventArgs e)
        {
            //Try-catch statement for exception handling
            try
            {
